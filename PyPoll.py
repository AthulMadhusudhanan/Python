...
filepath = os.path.join('Downloads', 'Starter_Code (2)', 'Starter_Code', 'PyPoll', 'Resources', 'election_data.csv')
...
# Set path for file
filepath = os.path.join('Downloads', 'Starter_Code (2)', 'Starter_Code', 'PyBank', 'Resources', 'PyPoll_Results.txt')
