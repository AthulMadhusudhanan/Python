...
import csv
# Set path for file
csvpath = os.path.join('Downloads', 'Starter_Code (2)', 'Starter_Code', 'PyBank', 'Resources', 'budget_data.csv')
...
# Set path for file
filepath = os.path.join('Downloads', 'Starter_Code (2)', 'Starter_Code', 'PyBank', 'Resources', 'PyBank_Results.txt')
